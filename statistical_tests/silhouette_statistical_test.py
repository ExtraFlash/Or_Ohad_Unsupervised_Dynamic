...
def perform_anova_test():
    scores_df = pd.read_csv('../data/silhouette_cvs_for_anova_test_data', index_col=0)
...
if __name__ == '__main__':
    ...
    # now we have 40 silhouette scores for each clustering method from test data
    # perform_anova_test()

    # we got pvalue=7.22e-3 for the ANOVA test
